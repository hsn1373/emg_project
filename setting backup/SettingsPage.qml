                ...
                Rectangle{
                    ...
                    Row{
                        ...
                        TextField
                        {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            text: qsTr("")
                            placeholderText: qsTr('CHOOSE SAVING PATH')
                            font.pointSize: UIStyle.fontSize
                            font.family: UIStyle.fontName
                            Material.theme: UIStyle.darkTheme ? Material.Dark : Material.Light
                            Material.accent: Material.primary
            ...
            Row {
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        default_settings.darkMode = UIStyle.darkTheme ? "true" : "false"
                        default_settings.fontSize = UIStyle.fontSize
                        default_settings.fonts =
                                UIStyle.fontArray[0] +','+UIStyle.fontArray[1] +','+UIStyle.fontArray[2] +','+UIStyle.fontArray[3] +','
                ...
                Button{
                    ...
                    onHoveredChanged: {
                        if(hovered)
                            reset.background.color = UIStyle.darkTheme ? '#ff0000' : '#aa0000'
                        else
                            reset.background.color = UIStyle.themeBlue
                    }
                }
